...
(* OASIS_START *)
(* DO NOT EDIT (digest: ef448513cca7b8f563e8a10d08b9e29e) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Hamt"];
                      lib_pack = false;
                      lib_internal_modules = ["BitUtils"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hamt";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "hamt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = true; exec_main_is = "param.ml"});
               Test
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "bench1.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\245\162\007\152M'k\200O\031\185\140\014s\026\028";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
